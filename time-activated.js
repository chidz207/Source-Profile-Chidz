...
console.log('%c- Có vẻ như bạn đang cố tình ăn cắp mã nguồn thanhdieu.com của tôi.', 'color: #444; font-size: 25px; font-family: sans-serif;');
